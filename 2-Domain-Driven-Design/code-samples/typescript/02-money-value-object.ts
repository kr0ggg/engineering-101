...
**Navigation**: [← Previous: Customer Entity](./01-customer-entity.ts) | [← Back to Introduction](../introduction-to-the-domain.md) | [← Back to TypeScript Index](./README.md)
...
- [Customer Entity](./01-customer-entity.ts) - Uses Money in domain operations
