...
8:T239d,<h1>Order Entity with Business Logic - TypeScript Example</h1>
<p><strong>Section</strong>: <a href="../../1-introduction-to-the-domain.md#business-logic-encapsulation">Domain Entities - Business Logic Encapsulation</a></p>
<p><strong>Navigation</strong>: <a href="./02-money-value-object.md">← Previous: Money Value Object</a> | <a href="../../1-introduction-to-the-domain.md">← Back to Introduction</a> | <a href="./04-email-address-value-object.md">Next: EmailAddress Value Object →</a></p>
<hr>
<pre><code class="language-typescript">// TypeScript Example - Order Entity with Business Logic
